 ...
 *
 * @see \Drupal\entity_events\Entity\EntityEvent.
 */
class EntityEventAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\entity_events\Entity\EntityEventInterface $entity */
    switch ($operation) {
      case 'view':
