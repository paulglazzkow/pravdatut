 ...
 */
class EntityEventRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new EntityEventRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'entity_event_revision_revert_confirm';
  }
   ...
   *
   * @param \Drupal\entity_events\Entity\EntityEventInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\entity_events\Entity\EntityEventInterface
